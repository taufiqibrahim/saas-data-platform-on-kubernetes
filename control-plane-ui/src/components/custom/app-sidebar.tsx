...
const WHITELISTED_TENANT_RESOURCES = ["workspaces"];
          ...
          <SidebarMenuItem>
            ...
            >
              <Link to="/">
                ...
                <span className="text-base font-semibold">SaaS Inc.</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              {Object.keys(resources)
                .filter((name) => resources[name].hasList)
                // Only keep resources that exist in our whitelist array
                .filter((name) => WHITELISTED_TENANT_RESOURCES.includes(name))
                .map((name) => (
                  <ResourceMenuItem
                    key={name}
                    name={name}
